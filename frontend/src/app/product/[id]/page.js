...
import { Star, Heart, ShoppingBag, Truck, RotateCcw, ShieldCheck, Plus, Minus, Phone, ArrowLeft } from 'lucide-react';

export default function ProductDetailPage() {
  const { id } = useParams();
  const router = useRouter();
  const { addToCart, user, API_URL, currencySymbol } = useContext(ShopContext);
  ...
  const handleReviewSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(data.message || 'Failed to submit review. You can only review products you have purchased.');
      }
    } catch (error) {
      console.error(error);
          ...
          <>
                ...
                <div className="lg:w-1/2 flex flex-col space-y-4 sm:space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-slate-400 text-xs font-semibold">({product.numReviews || 0} reviews)</span>
                    </div>
                    ...
                    {product.brand && (
                      <div className="text-xs text-slate-400">
                        <span className="font-bold text-slate-600">Brand:</span> {product.brand}
                      </div>
                    )}
                  </div>
                      ...
                      <div className="space-y-2.5">
                        <div className="flex gap-2 sm:gap-3">
                          ...
                          >
                            ...
                            <span className="sm:hidden inline">Cart</span>
                          </button>
                        ...
                        <div className="grid grid-cols-2 gap-2 sm:gap-3">
                          ...
                          >
                            ...
                            <span className="sm:inline hidden">WhatsApp</span>
                  ...
                  <div className="grid grid-cols-3 gap-2 border-t border-slate-100 pt-4 text-[10px] text-slate-500">
                    <div className="flex flex-col items-center text-center space-y-1">
                      ...
                      <span className="text-[10px]">Over $100</span>
                    </div>
                    <div className="flex flex-col items-center text-center space-y-1">
                    ...
                    <div className="flex flex-col items-center text-center space-y-1">
                      ...
                      <span className="text-[10px]">100% Secure</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {product.youtubeUrl && (
              <div className="mt-8 bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 shadow-sm space-y-4">
                <h3 className="text-base font-extrabold text-slate-800">Product Video Demonstration</h3>
            ...
            <div className="mt-12 bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 space-y-8 shadow-sm">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100 pb-6">
                <div>
                  <h2 className="text-xl sm:text-2xl font-extrabold text-slate-800">Customer Reviews</h2>
                  <p className="text-slate-500 text-xs mt-1">What our buyers say about this product.</p>
                </div>
                <div className="flex items-center gap-3 bg-slate-50 border border-slate-100 rounded-2xl px-4 py-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-slate-400 font-bold uppercase mt-0.5">{product.numReviews || 0} Reviews</div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-7 space-y-4">
                  <h3 className="text-xs font-black uppercase tracking-wider text-slate-450 mb-2">Recent Reviews</h3>
                ...
                <div className="lg:col-span-5 bg-slate-50 border border-slate-100 rounded-2xl p-6 space-y-4">
                  <h3 className="text-xs font-black uppercase tracking-wider text-slate-800">Write a Review</h3>
                  {user ? (
                    <form onSubmit={handleReviewSubmit} className="space-y-4 text-xs">
                      <div>
                        <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Your Rating</label>
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Comment</label>
                        <textarea
                          rows="4"
                          required
                          placeholder="What did you think of this product? Write your honest review here..."
                          value={reviewComment}
                    ...
                    <div className="text-center py-6 space-y-3">
                      <p className="text-xs text-slate-500 font-bold">Please log in to submit a review for this product.</p>
                      <button
            ...
            {relatedProducts.length > 0 && (
              <div className="mt-12">
                <h2 className="text-xl font-extrabold text-slate-800 mb-6">Related Products</h2>
