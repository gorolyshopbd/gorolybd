            ...
            {['login', 'register'].includes(authMode) && (
              <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 bg-slate-100 p-1.5 rounded-xl text-xs font-bold text-center mb-2">
                      <button
                        ...
                        className={`py-2 rounded-lg transition ${
                          accountType === 'customer' ? 'bg-white text-[#FF6600] shadow-xs ring-1 ring-orange-100' : 'text-slate-500 hover:text-slate-800'
                        }`}
                      >
                        Customer
                      </button>
                      <button
                        ...
                        className={`py-2 rounded-lg transition ${
                          accountType === 'seller' ? 'bg-white text-[#FF6600] shadow-xs ring-1 ring-orange-100' : 'text-slate-500 hover:text-slate-800'
                        }`}
                      >
                        Seller
                      </button>
                ...
                <div className={`relative ${authMode === 'register' ? 'rounded-2xl border border-sky-100 bg-sky-50/50 p-3 shadow-sm' : ''}`}>
                  ...
                  <div className="relative mt-1.5 group">
                    <input
                      ...
                      className={`w-full pl-11 pr-4 py-3 rounded-xl text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-hidden transition-all duration-300 ${
                        authMode === 'register'
                          ...
                          {!signupOtpSent ? (
                            ...
                            <button
                              ...
                              className={`px-4 py-2.5 text-white text-xs font-bold rounded-xl transition duration-300 whitespace-nowrap border-0 ${
                                signupPhoneVerified ? 'bg-emerald-500 cursor-default' : 'bg-emerald-500 hover:bg-emerald-600 shadow-md shadow-emerald-500/25 hover:-translate-y-0.5'
                              }`}
                            >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-3 mt-2 text-white font-bold rounded-xl shadow-lg transition duration-300 hover:-translate-y-0.5 disabled:opacity-70 disabled:hover:translate-y-0 ${
                    authMode === 'register'
                ...
                {!otpSent && (
                  <div className="grid grid-cols-2 gap-2 rounded-2xl bg-slate-50 p-1.5 text-xs font-bold text-center ring-1 ring-slate-200">
                    <button
                      ...
                      className={`flex items-center justify-center gap-1.5 rounded-xl py-2.5 transition duration-300 ${
                        otpType === 'email'
