...
CREATE TABLE IF NOT EXISTS settings (
  ...
  flash_sale_gradient_start    TEXT DEFAULT '#052e2b',
  flash_sale_gradient_mid      TEXT DEFAULT '#047857',
  flash_sale_gradient_end      TEXT DEFAULT '#00B894',
  flash_sale_radial_color      TEXT DEFAULT '#5eead4',
  flash_sale_accent_color      TEXT DEFAULT '#00B894',
