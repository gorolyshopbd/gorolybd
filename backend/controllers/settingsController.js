...
export const updateSettings = async (req, res) => {
  try {
    const {
      ...
      headerLogo, footerLogo, footerDescription, currency, currencySymbol, headerBgColor, headerTextColor,
    ...
    const updateData = {
      ...
      sas_sms_gateway_url: sasSmsGatewayUrl,
      sas_sms_api_key: sasSmsApiKey,
      sas_sms_secret_key: sasSmsSecretKey,
      sas_sms_sender_id: sasSmsSenderId,
      smtp_host: smtpHost,
      smtp_port: smtpPort,
      smtp_user: smtpUser,
      smtp_pass: smtpPass,
